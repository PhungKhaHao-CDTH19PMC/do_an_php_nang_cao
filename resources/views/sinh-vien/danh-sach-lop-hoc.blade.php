      ...
      <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form class="forms-sample" action="{{route('xl-them-lop-hoc')}}" method="post">
                      @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Nhập mã lớp</label>
                        <input type="text " class="form-control" id="exampleInputUsername1" placeholder="Mã lớp " name="ma_lop">
                      </div>
          ...
          @foreach($sinhVien->dsLopHoc as $ds)
